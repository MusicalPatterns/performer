...
import { NoteToPlay, PrepareOscillatorVoiceParameters, SpatializationType, StartNote, StopNote, Voice } from '../index'
...
const prepareOscillatorVoice: (prepareOscillatorVoiceParameters: PrepareOscillatorVoiceParameters) => Voice =
    ({ spatialization, timbre }: PrepareOscillatorVoiceParameters): Voice => {
